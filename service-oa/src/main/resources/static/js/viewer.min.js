...
!(function (t, i) {
        ...
        for (var t = 1; t < arguments.length; t++) {
            ...
            t % 2
                ? e(Object(o), !0).forEach(function (t) {
                      var i, e, n;
                      (i = s), (n = o[(e = t)]), e in i ? Object.defineProperty(i, e, { value: n, enumerable: !0, configurable: !0, writable: !0 }) : (i[e] = n);
                  })
    ...
    var o = { backdrop: !0, button: !0, navbar: !0, title: !0, toolbar: !0, className: "", container: "body", filter: null, fullscreen: !0, initialViewIndex: 0, inline: !1, interval: 5e3, keyboard: !0, loading: !0, loop: !0, minWidth: 200, minHeight: 100, movable: !0, rotatable: !0, scalable: !0, zoomable: !0, zoomOnTouch: !0, zoomOnWheel: !0, slideOnTouch: !0, toggleOnDblclick: !0, tooltip: !0, transition: !0, zIndex: 2015, zIndexInline: 0, zoomRatio: 0.1, minZoomRatio: 0.01, maxZoomRatio: 100, url: "src", ready: null, show: null, shown: null, hide: null, hidden: null, view: null, viewed: null, zoom: null, zoomed: null },
        ...
        k = "".concat(p, "-hide"),
        n = "".concat(p, "-hide-md-down"),
        v = "".concat(p, "-hide-sm-down"),
        z = "".concat(p, "-hide-xs-down"),
        D = "".concat(p, "-in"),
        T = "".concat(p, "-invisible"),
        E = "".concat(p, "-loading"),
        I = "".concat(p, "-move"),
        O = "".concat(p, "-open"),
        S = "".concat(p, "-show"),
        ...
        Y = "keydown",
        X = "load",
        F = t ? "pointerdown" : h ? "touchstart" : "mousedown",
        P = t ? "pointermove" : h ? "touchmove" : "mousemove",
        j = t ? "pointerup pointercancel" : h ? "touchend touchcancel" : "mouseup",
        W = "ready",
        A = "resize",
        H = "show",
        V = "shown",
    ...
    function bt(t, i, e) {
        var n;
        return nt(Event) && nt(CustomEvent) ? (n = new CustomEvent(i, { detail: e, bubbles: !0, cancelable: !0 })) : (n = document.createEvent("CustomEvent")).initCustomEvent(i, !0, !0, e), t.dispatchEvent(n);
    }
    function yt(t) {
        var i = t.rotate,
            e = t.scaleX,
    ...
    function kt(t, i) {
        ...
        return (
            ...
            (e.src = t.src),
            xt || ((e.style.cssText = "left:0;max-height:none!important;max-width:none!important;min-height:0!important;min-width:0!important;opacity:0;position:absolute;top:0;z-index:-1;"), n.appendChild(e)),
            e
        );
    }
    function zt(t) {
    ...
    var Tt = {
            ...
            initViewer: function () {
                var t,
                    i = this.options,
                    e = this.parent;
                i.inline && ((t = { width: Math.max(e.offsetWidth, i.minWidth), height: Math.max(e.offsetHeight, i.minHeight) }), (this.parentData = t)), (!this.fulled && t) || (t = this.containerData), (this.viewerData = ot({}, t));
            },
            ...
            initImage: function (r) {
                ...
                (this.imageInitializing = {
                    ...
                    (t = kt(i, function (t, i) {
                        ...
                        var o = { naturalWidth: t, naturalHeight: i, aspectRatio: e, ratio: (n = Math.min(0.9 * n, t)) / t, width: n, height: (s = Math.min(0.9 * s, i)), left: (c - n) / 2, top: (u - s) / 2 },
                            a = ot({}, o);
            ...
            renderImage: function (t) {
                var i = this,
                    e = this.image,
                    n = this.imageData;
                if ((rt(e, ot({ width: n.width, height: n.height, marginLeft: n.left, marginTop: n.top }, yt(n))), t))
        ...
        Et = {
            ...
            unbind: function () {
                var t = this.options,
                    ...
                    e = this.canvas,
                    n = this.element.ownerDocument;
                pt(i, L, this.onClick), pt(i, q, this.onDragStart), pt(e, F, this.onPointerDown), pt(n, P, this.onPointerMove), pt(n, j, this.onPointerUp), pt(n, Y, this.onKeyDown), pt(window, A, this.onResize), t.zoomable && t.zoomOnWheel && pt(i, "wheel", this.onWheel, { passive: !1, capture: !0 }), t.toggleOnDblclick && pt(e, N, this.onDblclick);
            },
        },
        It = {
            click: function (t) {
                    ...
                    this.initImage(function () {
                        ut(n, I, e.movable),
                            ...
                            t.renderImage(function () {
                                (t.viewed = !0), (t.viewing = !1), nt(e.viewed) && wt(i, K, e.viewed, { once: !0 }), bt(i, K, { originalImage: t.images[s], index: s, image: n });
                            });
                    });
            },
            loadImage: function (t) {
                ...
                kt(o, function (t, i) {
                    var e = t / i,
                        n = a,
                        s = r;
                    a < r * e ? (h ? (n = r * e) : (s = a / e)) : h ? (s = a / e) : (n = r * e), rt(o, ot({ width: n, height: s }, yt({ translateX: (a - n) / 2, translateY: (r - s) / 2 })));
                });
            },
            keydown: function (t) {
                var i = this.options;
            ...
            pointerdown: function (t) {
                ...
                if (!(!this.viewed || this.showing || this.viewing || this.hiding || (("mousedown" === t.type || ("pointerdown" === t.type && "mouse" === t.pointerType)) && ((G(n) && 1 !== n) || (G(s) && 0 !== s) || t.ctrlKey)))) {
                    t.preventDefault(),
                        t.changedTouches
                            ? st(t.changedTouches, function (t) {
                                  e[t.identifier] = Dt(t);
                              })
            ...
            pointerup: function (t) {
                ...
                t.changedTouches
                    ...
                    s &&
                        (t.preventDefault(),
                        !n.transition || (s !== d && s !== f) || lt(this.image, C),
                        (this.action = !1),
                        h &&
                            s !== f &&
                            i &&
        ...
        Ot = {
            ...
            view: function (t) {
                ...
                if (((u.src = l), (u.alt = c), nt(s.view) && wt(e, "view", s.view, { once: !0 }), !1 === bt(e, "view", { originalImage: this.images[i], index: i, image: u }) || !this.isShown || this.hiding || this.played)) return this;
                ...
                function d() {
                    var t,
                        i = n.imageData,
                        e = Array.isArray(s.title) ? s.title[1] : s.title;
                    o.innerHTML = _((t = nt(e) ? e.call(n, u, i) : "".concat(c, " (").concat(i.naturalWidth, " × ").concat(i.naturalHeight, ")")))
                        ? t
                ...
                return (
                    ...
                    u.complete
                        ? this.load()
                        : (wt(u, X, (m = this.load.bind(this)), { once: !0 }),
            ...
            zoomTo: function (t, i, e, n) {
                var s,
                    ...
                    h,
                    l = this,
                    c = 1 < arguments.length && void 0 !== i && i,
                    u = 2 < arguments.length && void 0 !== e ? e : null,
                ...
                if (G((t = Math.max(0, t))) && this.viewed && !this.played && (d || f.zoomable)) {
                    if (!d) {
                        var z = Math.max(0.01, f.minZoomRatio),
                            D = Math.min(100, f.maxZoomRatio);
                    ...
                    var T = x * t,
                        ...
                        O = E - w,
                        S = p / x;
                    if ((nt(f.zoom) && wt(m, "zoom", f.zoom, { once: !0 }), !1 === bt(m, "zoom", { ratio: t, oldRatio: S, originalEvent: u }))) return this;
                    if (((this.zooming = !0), u)) {
                        var C = ((r = this.viewer), { left: (h = r.getBoundingClientRect()).left + (window.pageXOffset - document.documentElement.clientLeft), top: h.top + (window.pageYOffset - document.documentElement.clientTop) }),
                            L =
                    ...
                    (v.width = T),
                        ...
                        this.renderImage(function () {
                            (l.zooming = !1), nt(f.zoomed) && wt(m, "zoomed", f.zoomed, { once: !0 }), bt(m, "zoomed", { ratio: t, oldRatio: S, originalEvent: u });
                        }),
                        c && this.tooltip();
                }
                return this;
            ...
            stop: function () {
                ...
                return (
                    ...
                    st(t.getElementsByTagName("img"), function (t) {
            ...
            full: function () {
                ...
                return (
                    !this.isShown ||
                        ...
                        this.open(),
                        lt(this.button, l),
                        i.transition && (ct(s, C), this.viewed && ct(n, C)),
                        lt(e, y),
                        e.setAttribute("style", ""),
                        rt(e, { zIndex: i.zIndex }),
                        this.initContainer(),
                        (this.viewerData = ot({}, this.containerData)),
                        this.renderList(),
                        this.viewed &&
                            this.initImage(function () {
                                t.renderImage(function () {
            ...
            exit: function () {
                ...
                return (
                    this.isShown &&
                        ...
                        i.transition && (ct(s, C), this.viewed && ct(n, C)),
                        ct(e, y),
                        rt(e, { zIndex: i.zIndexInline }),
                        (this.viewerData = ot({}, this.parentData)),
                        this.renderViewer(),
                        this.renderList(),
                        this.viewed &&
                            this.initImage(function () {
            ...
            tooltip: function () {
                ...
                return (
                    this.viewed &&
                        ...
                        this.tooltipping ? clearTimeout(this.tooltipping) : i.transition ? (this.fading && bt(e, B), lt(e, S), lt(e, b), lt(e, C), (e.initialOffsetWidth = e.offsetWidth), lt(e, D)) : lt(e, S),
            ...
            update: function () {
                ...
                var s = [];
                if (
                    (st(e ? [t] : t.querySelectorAll("img"), function (t) {
                        ...
                        value: function () {
                            if (!this.ready) {
                                ...
                                if (
                                    ...
                                    lt(s, h.title ? zt(Array.isArray(h.title) ? h.title[0] : h.title) : k),
                                    lt(a, h.navbar ? zt(h.navbar) : k),
                                    ut(r, k, !h.button),
                                    h.backdrop && (lt(n, "".concat(p, "-backdrop")), h.inline || "static" === h.backdrop || gt(l, U, "hide")),
                                    _(h.className) &&
                                        h.className &&
                                        h.className.split(Z).forEach(function (t) {
                                            lt(n, t);
                                        }),
                                    h.toolbar)
                                ) {
                                ...
                                if (h.inline) lt(r, x), rt(n, { zIndex: h.zIndexInline }), "static" === window.getComputedStyle(i).position && rt(i, { position: "relative" }), i.insertBefore(n, t.nextSibling);
                                else {
    ...
    if ((ot(Lt.prototype, Tt, Et, It, Ot, St), c.fn)) {
        ...
        (c.fn.viewer = function (r) {
            ...
            (c.fn.viewer.Constructor = Lt),
            (c.fn.viewer.setDefaults = Lt.setDefaults),
            (c.fn.viewer.noConflict = function () {
